...
- تتبع حالة الطلب (قيد الانتظار، مدفوع، جاري التنفيذ، مكتمل، ملغى).
...
- عند الضغط، يظهر Pop-up يطلب من المشتري تحديد سبب التواصل:
    - استفسار
    - تفاوض على السعر
    - طلب تصميم خاص (في حالة الحرفة)
...
- يتم تخزين قيمة العربون وتاريخ الإرسال بدقة.
...
### سيناريوهات الحماية
- � تنبيه الإدارة عند رفض مبرر
- 🏭 تخزين البضائع غير المسلمة
- 📉 تقليل ظهور البائع عند مشكلات متكررة
