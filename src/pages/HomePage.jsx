            ...
            >
              ...
              <form onSubmit={handleSearch} className="flex max-w-lg mx-auto md:mx-0">
                <Input
                  ...
                  className="rounded-r-none rounded-l-md py-3 px-4 text-darkOlive flex-grow focus:ring-2 focus:ring-burntOrange"
                />
                <Button type="submit" className="bg-burntOrange hover:bg-burntOrange/90 text-white rounded-l-none rounded-r-md px-6 py-3">
            ...
            {topCategories.map((category, index) => (
              ...
              >
                <Link to={`/explore?category=${category.id}`}>
                  <Card className="text-center p-6 hover:shadow-xl transition-shadow duration-300 glass-effect card-hover border-olivePrimary/20">
              ...
              >
                <Card className="overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col h-full card-hover border-olivePrimary/20">
                  ...
                  <CardContent className="flex-grow">
                    <div className="flex items-center text-sm text-darkOlive/80 mb-2">
                  ...
                  <CardFooter>
                    <Button asChild className="w-full bg-burntOrange hover:bg-burntOrange/90">
                      <Link to={`/gigs/${gig.id}`}>
                        عرض التفاصيل
            ...
            {topSellers.map((seller, index) => (
              ...
              >
                <Card className="text-center p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 card-hover border-olivePrimary/20">
                  ...
                  <p className="text-sm text-darkOlive/60 mb-2">{seller.skills.slice(0,2).join('، ')}</p>
